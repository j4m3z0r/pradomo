...
class TelemetryTest {
    ...
    @Test fun decode_charging() {
        ...
        // position (x, y metres) + heading (radians) golden vectors.
        val (x, y) = t.position!!
        assertEquals(-5.623f, x, 0.001f)
        assertEquals(-6.739f, y, 0.001f)
        assertEquals(1.475f, t.heading!!, 0.001f)
    }
    ...
    @Test fun decode_remote_control() {
        ...
        assertEquals(75, t.battery)
        val (x, y) = t.position!!
        assertEquals(-5.732f, x, 0.001f)
        assertEquals(-7.602f, y, 0.001f)
        assertEquals(1.386f, t.heading!!, 0.001f)
    }
